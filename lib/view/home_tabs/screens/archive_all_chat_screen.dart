...
class arichveAllChatScreen extends StatefulWidget {
  @override
  State<arichveAllChatScreen> createState() => _arichveAllChatScreenState();
}

class _arichveAllChatScreenState extends State<arichveAllChatScreen> {
    ...
    for (var i = 0; i < chats.length; i++) {
      try {
        collection.docs.forEach((element) {
          ...
          if (chats[i] == element["Id"]&&element["isFinished"]==true ) {
      ...
      body:
        ...
        child:StreamBuilder(
            stream: FirebaseFirestore.instance
                .collection('chat').where('providerId',isEqualTo: AuthHelper.authHelper.theUser.id).where('allDone',isEqualTo: true)
